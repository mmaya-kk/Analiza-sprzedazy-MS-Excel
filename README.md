...
1.  **Zaawansowane wyszukiwanie:** Wykorzystanie duetu funkcji `INDEKS` oraz `PODAJ.POZYCJĘ` do precyzyjnego wyciągania danych o produktach z największą/najmniejszą sprzedażą.
